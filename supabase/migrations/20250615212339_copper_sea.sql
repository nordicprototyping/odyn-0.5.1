...
-- Update sample data with date_of_birth - properly cast string to DATE type
UPDATE personnel_details
SET date_of_birth = CASE
  WHEN name = 'Sarah Chen' THEN '1985-04-15'::date
  WHEN name = 'Marcus Rodriguez' THEN '1978-09-22'::date
  WHEN name = 'Dr. Elena Volkov' THEN '1982-11-03'::date
  WHEN name = 'James Mitchell' THEN '1990-06-12'::date
  WHEN name = 'Aisha Patel' THEN '1995-02-28'::date
  WHEN name = 'Robert Kim' THEN '1988-07-19'::date
